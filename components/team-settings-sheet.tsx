...
import { X, Swords, UserPlus, Trash2, Loader2 } from "lucide-react";
import {
          ...
          <section>
            ...
            <div className="flex flex-col gap-2">
              ...
              >
                ...
                <Swords size={16} className={searchingOpponent ? "text-accent-foreground" : "text-muted-foreground"} />
              ...
              >
                ...
                <UserPlus size={16} className={searchingPlayers ? "text-accent-foreground" : "text-muted-foreground"} />
                <span className="flex-1 text-left">
