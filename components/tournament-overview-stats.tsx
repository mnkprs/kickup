...
export function TournamentOverviewStats({ tournaments }: TournamentOverviewStatsProps) {
  ...
  return (
    <section className="tournament-overview-stats px-5">
      <div className="tournament-overview-stats__grid grid grid-cols-4 gap-2.5">
        {stats.map((stat) => (
          <div
            key={stat.label}
            className="tournament-overview-stats__item flex flex-col items-center gap-1.5 rounded-xl bg-card border border-border shadow-card px-2 py-3"
          >
